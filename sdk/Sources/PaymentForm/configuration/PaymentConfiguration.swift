...
public class PaymentConfiguration {
    ...
    public init(paymentData: PaymentData, delegate: PaymentDelegate?, uiDelegate: PaymentUIDelegate?, scanner: PaymentCardScanner?, useDualMessagePayment: Bool = false, disableApplePay: Bool = false, disableYandexPay: Bool = false) {
